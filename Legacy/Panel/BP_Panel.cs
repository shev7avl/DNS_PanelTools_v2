...
namespace DSKPrim.PanelTools.Panel
{
    private class BP_Panel : BasePanel, IAssembler
    {
        ...
        private string GetPanelCode()
        {
            ...
            if (familySymbol.FamilyName.Contains("SupBranch"))
            {
                string i6 = Marks.AsDecimString(familySymbol, "Кронштейн1_Шаг");
                string i7 = Marks.AsDecimString(familySymbol, "Кронштейн2_Шаг");
                string i8 = Marks.AsDecimString(familySymbol, "Кронштейн3_Шаг");
                string i9 = Marks.AsDecimString(familySymbol, "Кронштейн4_Шаг");

                return $"{i3}.{i4}.{i5}_{i6}.{i7}.{i8}.{i9}";
            }
            else
            {
