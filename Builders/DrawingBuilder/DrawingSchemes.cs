...
{
    static class DrawingSchemes
    {

        private static DrawingSchema NS_SCHEMA = new DrawingSchema(new Dictionary<int, List<ViewTemplateName>>()
        {
        ...
        private static DrawingSchema VS_SCHEMA = new DrawingSchema(new Dictionary<int, List<ViewTemplateName>>()
        {
            { 1, new List<ViewTemplateName>()
                {
                ViewTemplateName.PANEL_3D_VIEW,
        ...
        private static DrawingSchema BP_SCHEMA = new DrawingSchema(new Dictionary<int, List<ViewTemplateName>>()
        {
            { 1, new List<ViewTemplateName>()
                {
                ViewTemplateName.PANEL_3D_VIEW,
        ...
        private static DrawingSchema PP_SCHEMA = new DrawingSchema(new Dictionary<int, List<ViewTemplateName>>()
        {
            { 1, new List<ViewTemplateName>()
                {
        ...
        private static DrawingSchema PS_SCHEMA = new DrawingSchema(new Dictionary<int, List<ViewTemplateName>>()
        {
            { 1, new List<ViewTemplateName>()
                {
                ViewTemplateName.PANEL_3D_VIEW,
        ...
        public static DrawingSchema GetNsSchema()
        { 
            return NS_SCHEMA;
        }
        public static DrawingSchema GetVsSchema()
        {
            return VS_SCHEMA;
        }
        public static DrawingSchema GetBpSchema()
        {
            return BP_SCHEMA;
        }
        public static DrawingSchema GetPpSchema()
        {
            return PP_SCHEMA;
        }
        public static DrawingSchema GetPsSchema()
        {
            return PS_SCHEMA;
        }
