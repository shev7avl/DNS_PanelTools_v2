    ...
    public class PrecastArchBuilder : ButtonBuilder
    {
        ...
        public override void BuildButtons()
        {
            List<Button> buttons = new List<Button>
            {
                ...
                new Button(SubPanelResult.RibbonPanel.RibbonPanel, Properties.Resource.wall.ToBitmap(), "DSKPrim.PanelTools.PanelMaster.ARCH_SplitToParts", "Split to parts", "Клинкерная плитка"),
                new Button(SubPanelResult.RibbonPanel.RibbonPanel, Properties.Resource.tile.ToBitmap(), "DSKPrim.PanelTools.PanelMaster.ARCH_SplitToPartsStraightLayout", "Split to parts straight", "Прямая плитка"),
