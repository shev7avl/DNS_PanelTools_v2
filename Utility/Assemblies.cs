...
namespace DSKPrim.PanelTools.Utility
{
    ...
    {
        public static void CreateAssembly(Document document, BasePanel item)
        {
        ...
        public static int CompareElementIdsByZCoord(BasePanel x, BasePanel y)
        {
        ...
        public static List<AssemblyDetailViewOrientation> DefineViewOrientations(Document document, ElementId assemblyInstanceId)
        {
            ...
            if (instance.FacingOrientation.IsAlmostEqualTo(f))
            {
            ...
            else if (instance.FacingOrientation.IsAlmostEqualTo( b))
            {
                orientations = new List<AssemblyDetailViewOrientation>()
                    {
